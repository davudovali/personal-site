...
console.log('enum COUNTRY_ISO_2 {')
COUNTRIES.forEach(({id, iso2Code, name, region}) => {
  console.log(`'${iso2Code}' = '${iso2Code.toLowerCase()}',`)
})
console.log('}')

console.log('const NAME_TO_ISO2 = {')
COUNTRIES.forEach(({id, iso2Code, name}) => {
  console.log(`"${name}"` + ':' +  `"${iso2Code}"` + ',')
})
